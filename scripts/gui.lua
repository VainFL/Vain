...
local getcustomassets = {
	...
	['vain/assets/guivape.png'] = 'rbxassetid://14657521312',
	...
	['vain/assets/textvape.png'] = 'rbxassetid://14368358200',
	['vain/assets/utilityicon.png'] = 'rbxassetid://14368359107',
	['vain/assets/vape.png'] = 'rbxassetid://14373395239',
...
function mainapi:Load(skipgui, profile)
	...
	if inputService.TouchEnabled and #self.Keybind == 1 and self.Keybind[1] == 'RightShift' then
		...
		image.Image = getcustomasset('vain/assets/vape.png')
		image.Parent = button
...
general:CreateButton({
	...
	Function = function()
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/7GrandDadPGN/VapeV4ForRoblox/'..readfile('vain/profiles/commit.txt')..'/loader.lua', true))()
		end
	end,
